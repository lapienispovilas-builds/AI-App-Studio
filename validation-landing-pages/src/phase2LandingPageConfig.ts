...
export const trackGlpPositioningPages: Phase2LandingPageConfig[] = [
  {
    ...
    brand: 'Evera',
    heroKicker: 'Protect the progress you worked for',
    ...
    problem: {
      ...
      description: 'Your dose matters, but so do weight, symptoms, hydration, protein, movement and the habits you build around treatment. Evera is designed to keep those pieces connected so your progress still makes sense when your treatment changes.',
    },
    howItWorks: [
      {
