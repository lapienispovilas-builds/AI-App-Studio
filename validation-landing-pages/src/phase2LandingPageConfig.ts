...
export const trackGlpPositioningPages: Phase2LandingPageConfig[] = [
  {
    ...
    subheadline: 'TrackGLP helps you maintain your progress after GLP-1 treatment with simple tracking, accountability, and habits designed for the maintenance phase.',
    ...
    signupHeadline: 'Be among the first to try TrackGLP.',
    problem: {
