...
export const trackGlpPositioningPages: Phase2LandingPageConfig[] = [
  {
    ...
    subheadline: 'Losing the weight is one chapter. Keeping your progress is the next. TrackGLP is being built to stay with you through both.',
    subheadlineHighlight: 'Keeping your progress is the next',
    cta: 'Keep my GLP-1 progress',
    stickyCta: 'Keep my GLP-1 progress',
    ...
    upcomingFeatures: {
      ...
      cards: [
        ...
        { title: 'Journey Mode', description: 'Switch between On treatment, Transition, and Maintaining so TrackGLP stays useful as your journey changes.' },
  ...
  },
  {
    ...
    subheadline: 'From your first dose to maintaining your progress later — keep your treatment, habits and progress connected in one place.',
