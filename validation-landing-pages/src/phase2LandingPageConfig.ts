...
export const phase2LandingPages: Phase2LandingPageConfig[] = [
  ...
  },
  {
    ...
    stickyCta: 'Join NextDate early access',
    benefits: [
  ...
  },
  {
    ...
    stickyCta: 'Start reconnecting with my partner',
    benefits: [
  ...
  },
  {
    ...
    stickyCta: 'Join RESET early access',
    benefits: [
...
export const trackGlpPositioningPages: Phase2LandingPageConfig[] = [
  {
    ...
    subheadline: 'Get a personalized GLP-1 maintenance plan designed around your journey, biggest challenges, and goals.',
    subheadlineHighlight: 'personalized GLP-1 maintenance plan',
    cta: 'Build My Plan',
    ctaSubtitle: 'Created for your GLP-1 journey.',
    stickyCta: 'Build My Plan',
    signupHeadline: 'Get your personalized maintenance plan.',
    problem: {
      ...trackGlpBase.problem!,
      description: 'Evera turns your answers into a focused maintenance program for the stage, challenges, and goals that matter to you now.',
    },
    howItWorks: [
      {
        ...trackGlpBase.howItWorks![0],
        title: 'Log the essentials',
        description: "Track your doses, weight and symptoms while you're on treatment.",
        screen: { mode: 'form', eyebrow: 'Today', title: 'Log the essentials', primary: '1.7 mg', rows: [{ label: 'Medication', value: 'Semaglutide' }, { label: 'Weight', value: '84.6 kg' }, { label: 'Symptoms', value: 'Mild' }], action: 'Save today' },
      },
      {
        ...trackGlpBase.howItWorks![1],
        title: 'Build the habits that support your progress',
        description: 'Keep movement, protein, hydration and everyday habits visible alongside your progress.',
        screen: { mode: 'checklist', eyebrow: 'Daily habits', title: 'Today', rows: [{ label: 'Water', value: '2.1 / 2.5 L' }, { label: 'Protein', value: '95 / 100 g' }, { label: 'Movement', value: '8,432 steps · Coming soon' }, { label: 'Consistency', value: '5 / 7 days' }], action: 'Complete day' },
      },
      {
        ...trackGlpBase.howItWorks![2],
        title: 'Keep going when treatment changes',
        description: 'Move into Transition or Maintaining mode while keeping the same history, habits and progress in one place.',
        screen: { mode: 'journey', eyebrow: 'Journey Mode · Coming soon', title: 'Maintaining', primary: 'Progress continues', rows: [{ label: 'Mode', value: 'On treatment · Transition · Maintaining' }, { label: 'Weight trend', value: 'Visible' }, { label: 'Movement', value: '7.8k avg' }, { label: 'Habit consistency', value: '6 / 7 days' }], action: 'View my journey' },
      },
    ],
    upcomingFeatures: {
      headline: 'Your dose is only one part of your whole story.',
      cards: [
        ...
        { title: 'Journey Mode', description: 'Switch between On treatment, Transition, and Maintaining so Evera stays useful as your journey changes.' },
        { title: 'Movement guidance', description: 'Simple educational guidance on staying active throughout your GLP-1 journey — without turning Evera into a complicated fitness app.' },
      ],
    },
    difference: {
    ...
    trustNote: 'Evera provides general educational guidance and planning support. It does not provide medical advice or replace support from a qualified healthcare professional.',
    socialProof: 'Answer a few questions about your GLP-1 journey and receive a plan designed around your current stage, challenges, and goals.',
    finalCta: undefined,
