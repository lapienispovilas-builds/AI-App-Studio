...
export const danishPlans: EveraPlan[] = [
  ...
  { id: 'complete-30', name: '30-dages vedligeholdelsesplan', price: '€14.99', description: 'Din komplette GLP-1-vedligeholdelsesplan til at beskytte dit vægttab og skabe vaner, der holder.', badge: 'Mest populær', positioning: 'Anbefalet til de fleste, fordi vedligeholdelsesvaner kræver kontinuitet.', includes: ['Personlig 30-dages plan', 'Ugentlige mål', 'Daglig vanetjekliste', 'Ernærings- og proteinvejledning', 'Styrke- og bevægelsesanbefalinger', 'Opfølgning på fremskridt', 'Vejledning til livet efter GLP-1'], cta: 'Start min 30-dages plan' },
