...
function AudioConversationPreview({config:c}:{config:VoicePageConfig}) {
 ...
 return <figure className="v-conversation v-audio-demo">
  <figcaption><div className="v-assistant-brand"><span className="v-avatar"><img src={voiceBrand.symbol} alt="" width={1125} height={991}/></span><span>Revomatix AI voice agent</span></div><strong>{c.workflowName}</strong><span>Example AI call</span></figcaption>
