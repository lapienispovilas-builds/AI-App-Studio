...
function VoiceLandingPage({ config: c }: { config: VoicePageConfig }) {
  ...
  return <div className="voice-page" id="top">
    ...
    <main id="main">
      ...
      <section id="contact" className="v-closing-band"><div className="v-container v-closing v-section"><div><p className="v-label">LET’S EXPLORE A PILOT</p><h2>{c.finalTitle}</h2><p className="v-lead-small">One focused workflow. Calls, {c.channel === 'SMS' ? 'texts' : 'emails'} and a clear next step for your team.</p></div><PilotForm question={c.pilot.question} intro={c.formIntro} heading={c.formHeading} /></div></section>
    </main>
