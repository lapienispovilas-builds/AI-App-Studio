...
export const chapterrLandingPage: ChapterrLandingPageConfig = {
  ...
  recognitionCards: [
    "You're building something most people around you don't understand",
    'You moved, changed careers, or entered a new environment',
    'Your priorities changed but your friendships stayed the same',
    "You're becoming someone new and looking for people who understand",
  ],
