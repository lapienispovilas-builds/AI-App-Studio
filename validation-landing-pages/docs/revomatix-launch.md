...
2. Required headers (any order): `Submission ID`, `Timestamp`, `Name`, `Work email`, `Company`, `Optional answer`, `Niche`, `Submission path`, `Original landing path`, `UTM source`, `UTM medium`, `UTM campaign`, `UTM content`, `UTM term`, `Referrer`, `Test traffic`.
